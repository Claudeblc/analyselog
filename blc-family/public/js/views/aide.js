// Aide : les gestes essentiels de BLC Family, expliqués simplement.
import { h } from '../core.js';

const FAQ = [
  ['📺 Connecter la télévision', 'Sur la TV, ouvrez l’adresse de BLC Family en ajoutant « ?tv=1 » (ou « ?tv=vertical » pour une TV verticale). Un QR code s’affiche : scannez-le avec votre téléphone et touchez « Autoriser ».'],
  ...
  ['🤝 Qui peut m’aider ?', 'Notre Famille : chacun a ses pastilles de compétences (santé, informatique, emploi, RH…). Écrivez votre besoin, BLC Family vous dit vers qui vous tourner.'],
